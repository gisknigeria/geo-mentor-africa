...
export function AccountMenu() {
  ...
  return (
    <div className="flex items-center gap-2">
      <Link href="/school" className="hidden rounded-lg bg-emerald-50 px-3 py-2 text-xs font-bold text-emerald-800 hover:bg-emerald-100 lg:inline-flex">School</Link>
      <Link href="/admin/onboarding" className="hidden rounded-lg bg-emerald-50 px-3 py-2 text-xs font-bold text-emerald-800 hover:bg-emerald-100 lg:inline-flex">Admin</Link>
